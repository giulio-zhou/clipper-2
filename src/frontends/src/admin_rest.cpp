 ...
 */
void AdminServer::application_admin_endpoint(
...
void AdminServer::send_to_server(std::string name, std::vector<VersionedModelId> models,
...
void AdminServer::add_endpoint(std::string endpoint, std::string request_method,
...
void AdminServer::start_listening() {
  HttpServer& s = server;
